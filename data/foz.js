 ...
 "escandalos": [
   ...
   "cadeia": [
    {
     ...
     "status_de": "Indiciado pela PF; apuração contra Ramagem arquivada por Moraes em 20/07/2026. Condenado pelo STF a 16 anos e 1 mês na trama golpista e foragido nos EUA.",
     "fonte": {
    ...
    },
    {
     ...
     "status_de": "Segundo a PF, Jair sabia da estrutura; apuração contra Jair arquivada por Moraes em 20/07/2026. Condenado na trama golpista.",
     "fonte": {
      "veiculo": "CNN Brasil",
  ...
  },
  {
   ...
   "numero": {
    ...
    "texto": "em dinheiro vivo na loja de chocolates de que ele era sócio, de 2015 a 2018, segundo o MP-RJ; denúncia anulada",
    "fonte": {
  ...
  },
  {
   ...
   "numero": {
    "valor": "R$ 2,7 milhões",
    "texto": "em dinheiro vivo que ele teria usado no esquema, segundo o MP-RJ; denúncia anulada",
    "fonte": {
     "veiculo": "ConJur",
     "url": "https://www.conjur.com.br/2020-nov-04/mp-denuncia-flavio-bolsonaro-esquema-rachadinha-alerj/",
     "data": "2020-11-04"
  ...
  },
  {
   ...
   "numero": {
    ...
    "texto": "de salário no gabinete dele, por quase um ano, a um ex-vice-presidente da Caixa que fez acordo no caso de assédio, segundo a Folha",
    "fonte": {
     "veiculo": "Folha de S.Paulo",
  ...
  },
  {
   ...
   "cadeia": [
    ...
    },
    {
     ...
     "status_de": "Removida pelo Facebook",
     "fonte": {
      "veiculo": "O Tempo",
  ...
  },
  {
   ...
   "numero": {
    "valor": "R$ 250 mil",
    "texto": "pagos por Frederick Wassef, ex-advogado dele, para recomprar nos EUA um Rolex do acervo presidencial, segundo o Metrópoles",
    "fonte": {
     "veiculo": "Metrópoles",
   ...
   "cadeia": [
    {
     ...
     "status_de": "ação penal na Justiça do Rio: denúncia contra 7 ex-assessores de Carlos recebida em 19/06/2026",
     "fonte": {
      "veiculo": "InfoMoney",
  ...
  },
  {
   ...
   "cadeia": [
    ...
    },
    {
     ...
     "para": "Flávio Bolsonaro",
     "relacao": "Presidia o BRB quando o banco concedeu a Flávio e à mulher dele o financiamento de R$ 3,1 mi em 360 parcelas para a mansão no Lago Sul (2021). O empréstimo foi quitado em cerca de três anos.",
  ...
  },
  {
   ...
   "numero": {
    ...
    "texto": "por ele na Alerj eram réus ou condenados em 2019, segundo a piauí",
    "fonte": {
     "veiculo": "piauí",
   ...
   "cadeia": [
    {
     ...
     "status_de": "contrato cancelado; a CPI da Covid pediu indiciamentos em 2021",
     "fonte": {
    ...
    },
    {
     ...
     "status_de": "a CPI da Covid pediu o indiciamento dele por seis crimes (2021), entre eles falsidade ideológica e fraude em contrato",
     "fonte": {
      "veiculo": "Poder360",
